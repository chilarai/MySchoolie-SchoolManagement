    ...
    $(window).load(function() {
        setTimeout(function() {
            $.gritter.add({
                ...
                text: 'A very warm greetings of the day',
...
var Dashboard = function () {
    ...
    return {
        ...
        init: function () {
            ...
            $.getScript('plugins/flot/jquery.flot.min.js').done(function() {
                $.getScript('plugins/flot/jquery.flot.time.min.js').done(function() {
                    $.getScript('plugins/flot/jquery.flot.resize.min.js').done(function() {
                        $.getScript('plugins/flot/jquery.flot.pie.min.js').done(function() {
            ...
            $.getScript('plugins/sparkline/jquery.sparkline.js').done(function() {
                handleDashboardSparkline();
            });
            
            $.getScript('plugins/jquery-jvectormap/jquery-jvectormap.min.js').done(function() {
                $.getScript('plugins/jquery-jvectormap/jquery-jvectormap-world-mill-en.js').done(function() {
                    handleVectorMap();
                });
            });
