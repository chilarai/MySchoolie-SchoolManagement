...
var DashboardV2 = function () {
    ...
    return {
        //main function
        init: function () {
            $.getScript('plugins/morris/raphael.min.js').done(function() {
                $.getScript('plugins/morris/morris.js').done(function() {
            ...
            $.getScript('plugins/jquery-jvectormap/jquery-jvectormap.min.js').done(function() {
                $.getScript('plugins/jquery-jvectormap/jquery-jvectormap-world-merc-en.js').done(function() {
                    handleVisitorsVectorMap();
                });
            });
            
            $.getScript('plugins/bootstrap-calendar/js/bootstrap_calendar.min.js').done(function() {
