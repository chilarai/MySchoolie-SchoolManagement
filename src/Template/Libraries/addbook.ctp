        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="name" data-parsley-required="true" class="form-control" placeholder="Name"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <?php echo $this->Form->input('category_id', array('type'=>'select','class'=>'form-control','label'=>false, 'options'=>$category));?>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="quantity" data-parsley-required="true"  data-parsley-type="number" class="form-control" placeholder="Quantity"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="author" data-parsley-required="true" class="form-control" placeholder="Author"/>
                    </div>
                </div>
           ...
           <!-- <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group date" id="datetimepicker1">
                            <input type="text" name="publish_date" class="form-control"  data-parsley-required="true"/>
				...
				<div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="price" data-parsley-required="true" class="form-control" placeholder="Price"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="isbn_code" data-parsley-required="true" class="form-control" placeholder="ISBN Code"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="book_code" data-parsley-required="true" class="form-control" placeholder="Book Code"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="publication" data-parsley-required="true" class="form-control" placeholder="Publication"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <textarea name="description" data-parsley-required="true" class="form-control" placeholder="Description" ></textarea>
                    </div>
                </div>
