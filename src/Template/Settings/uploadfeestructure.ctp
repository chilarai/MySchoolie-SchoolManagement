    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Upload Fee Structure CSV File</h4>
            </div>
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <a href='<?php echo BASE_URL.'uploads/csv/fee_structure_sample.csv' ?>' class="btn btn-warning">Download Sample CSV</a>
                    </div>
                </div>
