        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
            ...
            <div class="panel-body">
                <form class="form-horizontal">
                    ...
                    <div class="col-md-9">
                        <div   class="date datepicker">
                            <input type="date"  name="date1"  data-date-format="mm-dd-yyyy" class="form-control" >
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div   class="date datepicker">
                            <input type="date"  name="date2"  data-date-format="mm-dd-yyyy" class="form-control" >
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <select name="report_type" class="form-control">
                            <option value="1">Pending Collection</option>
                            <option value="2">Collected Payments</option>
                            <option value="3">Class Wise Collection</option>
                        </select>
                    </div>
