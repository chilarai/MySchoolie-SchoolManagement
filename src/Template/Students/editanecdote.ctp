        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
            ...
            <form class="form-horizontal" method="post"  enctype='multipart/form-data'  data-parsley-validate="true"  >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <?php echo $anecdote_details['student_name'];?>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-md-3 control-label">Teacher</label>
                        <div class="col-md-9">
                        <?php echo $anecdote_details['teacher_name'];?>
                        </div>
					...
					<label class="control-label col-md-3" >Student Anecdote<i class="fa fa-asterisk text-danger f-s-8"></i></label>
						<div class="col-md-9">
							<textarea class="form-control" rows="20" name="anecdote"  data-parsley-required="true"><?php echo $anecdote_details['anecdote_details'];?></textarea>
						</div>
					</div>
