    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">New Assignment</h4>
            </div>
            <div class="panel-body">
                ...
                <?php echo $this->Form->create('upload',['type'=>'file','method'=>'POST','data-parsley-validate'=>"true",'class'=>'form-horizontal']);?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <?php echo $this->Form->input('subject_id', array('type'=>'select','class'=>'form-control','label'=>false, 'options'=>$subject));?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="input-group date" id="datetimepicker1">
                                <input type="text" class="form-control" name="submission_date" data-parsley-required="true"/>
