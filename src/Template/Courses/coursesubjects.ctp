    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">New Relation</h4>
            </div>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title">New Course Subject Relation</h4>
								</div>
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
            ...
            <div class="panel-body">
                <table class="table">
                    ...
                    <tbody>
                        <?php foreach ($relation_list as $key => $value): ?>
							<tr>
								<td><?php echo $value['course_name'];?></td>
								<td><?php echo $value['subject_name'];?></td>
								<td><div><button class="btn btn-warning" onclick="location.href='/courses/editrelation/<?php echo $value['id'];?>'">Edit</button></div></td>
								<td><div><a class="btn btn-warning" href="#<?php echo $value['id'];?>" data-toggle="modal">Delete</a></div></td>
							...
							<div class="modal fade" id="<?php echo $value['id'];?>">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
											<h4 class="modal-title">Delete Course Subject Relation</h4>
										</div>
										<div class="modal-body">
											Are you sure you want to proceed?
										</div>
										<div class="modal-footer">
											<a href="javascript:;" class="btn btn-sm btn-white" data-dismiss="modal">Close</a>
											<a class="btn btn-warning" href="<?php echo BASE_URL;?>courses/deleterelation/<?php echo $value['id'];?>">Proceed</a>
										</div>
									</div>
								</div>
							</div>
