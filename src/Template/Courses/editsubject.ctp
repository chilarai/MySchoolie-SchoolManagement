            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" data-parsley-validate="true">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="name" class="form-control" data-parsley-required="true" value="<?php echo $subject_list['name'];?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Remarks</label>
                        <div class="col-md-9">
                            <textarea class="form-control" name="remark" data-parsley-required="true"><?php echo $subject_list['remark'];?></textarea>
                        </div>
                    </div>
